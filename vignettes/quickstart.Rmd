...
To install `loewesadditivity`, run the folllowing code.
...
This is a raw set of GIA data that has been collected and uploaded to this package.  We measure the GIA% for different experiements, plates (a or b) and repetitions.  We are using the compounds AMA1RON2 and RH5.  
